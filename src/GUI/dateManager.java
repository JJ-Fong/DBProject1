...
public class dateManager {
    ...
    public int[] byPart(String date) {
        ...
        if (defensive(date)) {
            fecha[0] = Integer.parseInt(date.substring(8,10)); 
            fecha[1] = Integer.parseInt(date.substring(5,7)); 
            fecha[2] = Integer.parseInt(date.substring(0,4));
        }
        return fecha; 
    }
    ...
    public String toSQLFormat(String date) { 
        String datef = "";
        int[] parts = this.byPart(date);
        datef = String.valueOf(parts[2])+"-"+String.valueOf(parts[1])+"-"+String.valueOf(parts[0]);
        return datef;
    }
}
