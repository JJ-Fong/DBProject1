...
table
:	K_CREATE  K_TABLE  ID '(' (atributo (',' atributo)*)+ (constraints) ')'	#createTB
...
;
 ...
 constraint
:	ID K_PRIMARY  K_KEY '(' conjuntoId ')'							# cPK
|	ID K_FOREIGN  K_KEY '(' conjuntoId ')' references					# cFK
