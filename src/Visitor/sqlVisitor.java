...
public interface sqlVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link sqlParser#variosId}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitVariosId(@NotNull sqlParser.VariosIdContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link sqlParser#literalString}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitLiteralString(@NotNull sqlParser.LiteralStringContext ctx);
	/**
